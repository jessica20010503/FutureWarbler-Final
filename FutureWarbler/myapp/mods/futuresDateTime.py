...
def futuresDateTime(futures,start,end,freq):
    if futures =="tf":
        df = pd.read_csv(".2017-2021-tf-1min.csv")
    elif futures =="te":
        df = pd.read_csv("2017-2022-te-1min.csv")
    elif futures =="tx":
        df = pd.read_csv("2017-2022-tx-1min.csv")
    elif futures =="mtx":
        df = pd.read_csv("2017-2022-mtx-1min.csv")
    elif futures =="corn":
        df = pd.read_csv("./myapp/mods/2017-2022-corn-1min.csv")
    elif futures =="mini_nasdaq":
        df = pd.read_csv("2017-2022-E-mini-nasdaq-1min.csv")  
    elif futures =="mini_russell":
        df = pd.read_csv("2017-2022-E-mini-russell-1min.csv")  
    elif futures =="mini_sp":
        df = pd.read_csv("./myapp/mods/2017-2022-E-mini-s&p-1min.csv") 
    elif futures =="mini_dow" :
        df = pd.read_csv("2017-2022-mini_dow_1min.csv") 
    elif futures =="soybean" :
        df = pd.read_csv("2017-2022-soybean-1min.csv") 
    elif futures =="wheat":
        df = pd.read_csv("2017-2022-wheat-1min.csv") 
    else:
        df = pd.read_csv("2021-2022-a_debt-1min.csv") 
